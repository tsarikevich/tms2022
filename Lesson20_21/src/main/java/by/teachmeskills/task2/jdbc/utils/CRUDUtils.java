...
public class CRUDUtils {
    private static final String GET_ALL_STUDENTS_WITH_CITIES_QUERY = "SELECT * FROM students LEFT JOIN studentsCity ON id=idCity;";
    ...
    private static final String INSERT_CITY_QUERY = "INSERT INTO studentsCity(idCity,city) VALUES(?,?);";
    ...
    public static List<Student> addCity(CityStudent city) {
        List<Student> updatedStudentsCities = new ArrayList<>();
        try (Connection connection = DbUtils.getConnection()) {
            ...
            preparedStatement.executeUpdate();
            updatedStudentsCities = getAllStudentsWithCities();
        } catch (SQLException e) {
            System.out.println(e.getMessage());
        }
