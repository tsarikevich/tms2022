...
<div id="container" style="text-align: center;">
    <form id="signinForm" method="post" action='${contextPath}/home'>
        <div id="signinLbl">
            Авторизация
        </div>
        <input id="login" type="text" placeholder="Логин" name="username" oninput="validateLogin()"
        ...
        <div style="padding-top: 16px">
            ...
            <a onClick='location.href="/registration"' style="cursor: pointer;color: #0000CD">Зарегистрироваться</a>
        </div>
    </form>
</div>
</body>
