...
<c:if test="${isNewUserAdd==true}">
    <div id="container" style="text-align: center;">
        <form id="registrationForm" method="post" action='${contextPath}/registration' onsubmit="return validateForm()">
            ...
            <div style="padding-top: 16px">
                ...
                <a onClick='location.href="/home"' style="cursor: pointer;color: #0000CD">Войти</a>
            </div>
        </form>
    </div>
</c:if>
<c:if test="${isNewUserAdd==false}">
    <div class="container" style="text-align: center;">
        ...
        <div class="btn-group" style="">
            <button type="button" class="btn btn-info" onClick='location.href="/registration"'>Регистрация</button>
            <button type="button" class="btn btn-primary" onClick='location.href="/home"'>Авторизация</button>
        </div>
    </div>
</c:if>
</body>
