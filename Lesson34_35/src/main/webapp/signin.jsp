...
<div id="container" style="text-align: center;">
    <form id="signinForm">
        ...
        <input id="login" type="text" placeholder="Логин" name="userLogin" oninput="validateLogin()"
        ...
        <div style="padding-top: 16px">
            ...
            <a onClick='location.href="/eshop?command=registration"' style="cursor: pointer;color: #0000CD">Зарегистрироваться</a>
        </div>
    </form>
</div>
</body>
