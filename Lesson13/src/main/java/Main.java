...
public class Main {
    public static void main(String[] args) {
        StringBuilder stringBuilder = new StringBuilder("A12adaHellobBfbf");
        System.out.println(stringBuilder.substring(stringBuilder.indexOf("A"), stringBuilder.lastIndexOf("B")));
